...
<body>
    <form class="form" action="{{ route('login') }}" method="post" id="loginform">
            ...
            <div>
                <svg class="mySVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <path class="face" fill="#DDF1FA"
                        d="M134.5,46v35.5c0,21.815-15.446,39.5-34.5,39.5s-34.5-17.685-34.5-39.5V46"></path>
                    ...
                    <g class="mouth">
                        ...
                        <path style="display: none;" class="mouthLargeBG"
                            ...
                            fill="#617e92" stroke="#3a5e77" stroke-linejoin="round" stroke-width="2.5"></path>
                        <defs>
                        ...
                        <g clip-path="url(#mouthMask)">
                            <g class="tongue">
                                ...
                                <ellipse class="tongueHighlight" cx="100" cy="100.5" rx="3"
                                    ry="1.5" opacity=".1" fill="#fff"></ellipse>
                            </g>
                        </g>
                        <path clip-path="url(#mouthMask)" class="tooth" style="fill:#FFFFFF;"
                            d="M106,97h-4c-1.1,0-2-0.9-2-2v-2h8v2C108,96.1,107.1,97,106,97z"></path>
                    ...
                    <g class="arms" clip-path="url(#armMask)">
                        <g class="armL" style="visibility: hidden;">
                            <polygon fill="#DDF1FA" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round"
                                ...
                                points="121.3,98.4 111,59.7 149.8,49.3 169.8,85.4"></polygon>
                            <path fill="#DDF1FA" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round"
                                stroke-linejoin="round" stroke-miterlimit="10"
                            ...
                            <path fill="#DDF1FA" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round"
                                stroke-linejoin="round" stroke-miterlimit="10"
                                d="M150.9,59.4l26-7c2.7-0.7,5.4,0.9,6.1,3.5v0c0.7,2.7-0.9,5.4-3.5,6.1l-21.3,5.7"></path>
        ...
        <div class="inputGroup inputGroup1">
            ...
            <input required="" type="username" name="username" id="loginEmail" maxlength="254" value="{{ session('username') }}">
        </div>
        <div class="inputGroup inputGroup2">
            <label for="loginPassword" id="loginPasswordLabel">Password</label>
            <input required="" type="password" name="password" class="input"
			value="{{ session('password') }}" id="loginPassword">
        ...
        <div class="inputGroup inputGroup3">
            <button id="login" class="button-submit">Log in</button>
        </div>
		<p class="p">Don't have an account? <a href="{{ url('/register') }}">Sign Up</a>
    </form>
    <script>
        ...
        var emailHelper = document.querySelector('.helper1');
